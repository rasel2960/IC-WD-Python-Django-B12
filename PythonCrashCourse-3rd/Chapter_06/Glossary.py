...
meaning = glossary['loop'].capitalize()
print(f"{'loop'.title()}: {meaning}")

meaning = glossary['list'].capitalize()
print(f"{'list'.title()}: {meaning}")

meaning = glossary['dictionary'].capitalize()
print(f"{'dictionary'.title()}: {meaning}")
